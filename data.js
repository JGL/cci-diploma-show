  ...
  animal: {
    ...
    areaColors: {
      ...
      ha8e72e: {
        cmd: "text",
        txt:
          "Project by Eunah Lee\n\nHelp Haru find its way back home!\nAn interactive storybook for kids\n\nClick to view project.",
        align: "left",
        lines: 6,
        url: "https://harus-adventure.glitch.me/",
        project: "Haru's Adventure",
        point: [34, 73],
        obstacle: false,
      },
      hff0000: {
  ...
  care: {
    ...
    areaColors: {
      ...
      hff0000: {
        cmd: "text",
        txt:
          "Project by Mia Stoces-Brown\n\nEverybody is just trying to get from A to B.\n\nClick to view project.",
        align: "left",
        lines: 6,
        url: "https://from-a-to-b-.glitch.me",
        project: "From A to B",
        point: [24, 80],
        obstacle: false,
      },
      h0000ff: {
        cmd: "text",
        txt:
          "Project by Bea Taylor Searle\n\nIn a world where we can't hold hands, let's feel closer online.\n\nClick to view project.",
        align: "left",
        lines: 6,
        url: "http://holding-hands2.glitch.me/",
      ...
      h312783: {
        cmd: "video",
        student: "bea",
        url: "https://youtu.be/n1W8W9TUKfY",
        artistname: "Bea Taylor Searle",
        point: [64, 80],
        obstacle: false,
      },
      h056c38: {
    ...
    things: {
      ...
      yellowCushion: {
        file: "objects/yellowCushion.png",
        frames: 1,
        frameDelay: 30,
        position: [63, 63],
  ...
  social: {
    ...
    areaColors: {
      ...
      h312783: {
        ...
        url: "https://common-denominator.glitch.me/",
        student: "max",
        artistname: "Maximilian Zimmerer",
        point: [92, 78],
        obstacle: true,
      },
      he6007e: {
  ...
  disco: {
    ...
    areaColors: {
      ...
      hffff00: {
        cmd: "text",
        txt:
          "Project by Laiqa Mohid\n\nA musical collaboration built through eye contact\n\nClick to view project.",
        align: "left",
        lines: 6,
        url: "https://eye-orchestra.glitch.me/",
        project: "Eye Orchestra",
        point: [64, 78],
        obstacle: true,
      },
      h0000ff: {
        cmd: "text",
        txt: "Project by Kirsty Proud\n\nClick to view project.",
        align: "left",
        lines: 3,
        url: "https://acid-with-highscore.glitch.me/",
        project: "Acid",
        point: [92, 78],
        obstacle: true,
      },
      hff00ff: {
        cmd: "text",
        txt:
          "Project by Rukiah Zakaria\n\nA body instrument, music video making place in space!\n\nClick to view project.",
        align: "left",
        lines: 6,
        url: "https://breakdown-the-mimi-mix.glitch.me/",
        project: "Breakdown the Mimi Mix",
        point: [10, 86],
        obstacle: true,
      },
      //TV icons
  ...
  gallery: {
    ...
    areaColors: {
      ...
      h00ff00: {
        ...
        align: "left",
        lines: 5,
        url: "https://speech-bubbles.glitch.me/",
      ...
      hff0000: {
        ...
        align: "left",
        lines: 7,
        url: "https://ghost-tales.glitch.me/",
        project: "Ghost Tales",
        point: [64, 78],
        obstacle: true,
      },
      h0000ff: {
        cmd: "text",
        txt: "Project by Riya Maria\n\nClick to view project.",
        align: "left",
        lines: 3,
        url: "https://allseeing--eyes.glitch.me/",
      ...
      he6007e: {
        cmd: "video",
        url: "https://www.youtube.com/watch?v=KRUbhRKiauA",
        student: "jessie",
        artistname: "Jessie Zhang",
        point: [34, 78],
        obstacle: true,
      },
      h312783: {
  ...
  food: {
    ...
    areaColors: {
      ...
      hffff00: {
        cmd: "text",
        txt:
          "Project by Khalisha Tambunan\n\nIt's raining cats and dogs... and everything in between.\n\nClick to view project.",
        align: "left",
        lines: 6,
        url: "https://testkitsc.glitch.me/",
        project: "Kitschen Dreams",
        point: [34, 78],
        obstacle: true,
      },
      hff0000: {
  ...
  game: {
    ...
    areaColors: {
      ...
      h0000ff: {
        cmd: "text",
        txt:
          "Project by Dejana Draganić\n\nHow many bubbles can you pop?? Designed to trigger a 30 second burst of movement.\n\nClick to view project.",
        align: "left",
        lines: 7,
        url: "https://shake-it-out-.glitch.me/",
        project: "Shake it Out!",
        point: [92, 78],
        obstacle: true,
      },
      hff00ff: {
  ...
  view: {
    ...
    areaColors: {
      ...
      ha8e72e: {
        cmd: "text",
        txt:
          "Project by Morgan Williams\n\nAn interactive randomised location of a view of a city, every time you reload the page. Try moving one hand then the other up and down to see what happens.\n\nClick to view project.",
        align: "left",
        lines: 9,
        url: "https://views-from-a-room.glitch.me/",
        project: "Views from a Room",
        point: [34, 78],
        obstacle: true,
      },
      hffff00: {
        cmd: "text",
        txt: "Project by Ella Jonquil Fitzgerald\n\nClick to view project.",
        align: "left",
        lines: 3,
        url: "https://webcam-socket-io.glitch.me/",
        project: "Quarantine Kiss",
        point: [64, 78],
        obstacle: true,
      },
      h0000ff: {
      ...
      hff00ff: {
        ...
        url: "https://webcam-socket-io.glitch.me/",
        student: "ella",
        artistname: "Ella Jonquil Fitzgerald",
        point: [64, 78],
        obstacle: true,
      },
      hff0000: {
        ...
        url: "https://root-dandy-position.glitch.me/",
        student: "cat",
        artistname: "Catherine Rose Lavender",
        point: [92, 78],
        obstacle: true,
      },
    },
