...
module.exports.ROOMS = {
    ...
    animal: {
        ...
        areaColors: {
            ...
            //TV icons
            hf39200: { cmd: "video", url: "https://eunah-lee-storybook5-6.glitch.me/", label: "info", point: [34, 73], obstacle: false},
            he6007e: { cmd: "video", url: "https://dog-game-website-.glitch.me/", label: "info", point: [74, 73], obstacle: false }
        },
        things: {
    ...
    care: {
        ...
        areaColors: {
            ...
            //TV icons
            hff00ff: {cmd: "video", url: "https://from-a-to-b-.glitch.me", label: "info", point: [24, 73], obstacle: false},
            h312783: {cmd: "video", url: "https://youtu.be/n1W8W9TUKfY", label: "info", point: [64, 80], obstacle: false},
            h056c38: {cmd: "video", url: "https://when-our-hands-touch.glitch.me/", label: "info", point: [100, 80], obstacle: false}
    ...
    social: {
        ...
        areaColors: {
            ...
            //TV icons
            hf39200: { cmd: "video", url: "https://2020-06-06-regard-socket-app.glitch.me/", label: "info", point: [34, 78], obstacle: true },
            h00b9ee: { cmd: "video", url: "https://observe-.glitch.me/", label: "info", point: [64, 78], obstacle: true },
            h312783: { cmd: "video", url: "https://common-denominator.glitch.me/", label: "info", point: [92, 78], obstacle: true },
            he6007e: { cmd: "video", url: "https://manipulated-living.glitch.me/", label: "info", point: [100, 88], obstacle: true }
        }
    },
    ...
    disco: {
        ...
        areaColors: {
            ...
            //TV icons
            h312783: { cmd: "video", url: "https://inky-simple-dryosaurus.glitch.me/", label: "info", point: [34, 78], obstacle: true },
            h00ffff: { cmd: "video", url: "https://eye-orchestra-final.glitch.me/", label: "info", point: [64, 78], obstacle: true },
            he6007e: { cmd: "video", url: "https://acid-with-highscore.glitch.me/", label: "info", point: [92, 78], obstacle: true },
            hf39200: { cmd: "video", url: "https://breakdown-the-mimi-mix.glitch.me/", label: "info", point: [10, 86], obstacle: true }
        }
    },
    ...
    food: {
        ...
        areaColors: {
            ...
            //TV icons
            hf39200: { cmd: "video", url: "https://testkitsc.glitch.me/", label: "info", point: [34, 78], obstacle: true },
            h006b2d: { cmd: "video", url: "https://time-to-eat.glitch.me/", label: "info", point: [94, 78], obstacle: true }           
        },
        things: {
    ...
    draw: {
        ...
        areaColors: {
            ...
            //TV icons
            hf39200: { cmd: "video", url: "https://draw-together-again.glitch.me/", label: "info", point: [34, 78], obstacle: true },
            hff0000: { cmd: "video", url: "https://better-together.glitch.me/", label: "info", point: [92, 78], obstacle: true }
        },
        things:{
    ...
    view: {
        ...
        areaColors: {
            ...
            //TV icons
            hf39200: { cmd: "video", url: "https://views-from-a-room.glitch.me/", label: "info", point: [34, 78], obstacle: true },
            hff00ff: { cmd: "video", url: "https://webcam-socket-io.glitch.me/", label: "info", point: [64, 78], obstacle: true },
            hff0000: { cmd: "video", url: "https://root-dandy-position.glitch.me/", label: "info", point: [92, 78], obstacle: true }            
        }
    },
};